...
import (
	...
	"github.com/ubuntu/ubuntu-insights/server-services/cmd/ingest-service/daemon"
...
func TestRootCmd(t *testing.T) {
	...
	assert.Equal(t, constants.IngestServiceCmdName, cmd.Name())
}
